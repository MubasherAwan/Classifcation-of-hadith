...
import pandas as pd 
df = pd.read_excel("C:/Users/iammu/OneDrive/Desktop/comparison/Overall Comparison (after removing error in rule-based)/Exact_RuleBased_OldNER_NewNERNamesFrom480Hadith.xlsx")
...
# finalNarratorsNameListForSingleHadith=[]

# hadithList = df2["HadithText"][9]
...
#     finalNarratorsNameListForSingleHadith.append(return_M_List)
# else:
#     return_S_List = singleSanad(hadithList)
#     finalNarratorsNameListForSingleHadith.append(return_S_List)  


# df3 = pd.DataFrame()
# df3["justOne"] = finalNarratorsNameListForSingleHadith
# df3.to_excel("C:/Users/iammu/OneDrive/Desktop/oneHadith.xlsx")      
###########################################
